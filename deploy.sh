#!/bin/bash
# =========================================================
#  VANTAGE — Deploy Cycle Script
#  Git → SSH → Docker Rebuild → Live
# =========================================================
#
#  Usage (from your local vantage project directory):
...
echo -e "${CYAN}╔══════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     VANTAGE DEPLOYMENT CYCLE              ║${NC}"
...
COMMIT_MSG="${1:-deploy: update vantage production $(date '+%Y-%m-%d %H:%M')}"
...
echo -e "${CYAN}║     https://vantageai.live is live         ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════╝${NC}"
