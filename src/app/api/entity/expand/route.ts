...
/**
 * Thin proxy to the VANTAGE Intelligence Layer (vantage-intel).
 *
 * In Docker: fetches from http://vantage-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[VANTAGE] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
