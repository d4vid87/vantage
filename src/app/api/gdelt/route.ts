...
/**
 * VANTAGE — Real-Time Geopolitical Events (GDELT 2.0 GeoJSON API)
...
export async function GET() {
  try {
    ...
    for (const rawItem of rawItems) {
      ...
      // Map GDACS event types to Vantage types. WF and DR used to fall through
    ...
    console.error('[VANTAGE] GDACS fetch error:', error);
