/**
 * VANTAGE Intelligence Layer — vantage-intel
 *
...
const WIKIDATA_UA = 'VANTAGE-Intel/1.0 (https://vantageai.live; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'VANTAGE Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] VANTAGE Intelligence Layer starting...');
  await loadSanctions();
